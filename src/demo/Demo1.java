...
public class Demo1 {
	...
	public static void main(String[] args) throws MalformedURLException {
		 ...
		 * findElementByAndroidUIAutomator("new UiScrollable(new UiSelector().scrollable(true).instance(0)).scrollIntoView(new UiSelector().textContains(\"Views\").instance(0))"
		 * );
		 * 
		 * driver.findElement(By.xpath("//android.widget.TextView[@text='Views']")).
		 * click();
		 * 
		 * //driver.findElement(By.xpath("//*[@text=]")).click();("text(\"Views\")").
		 * click();
		 * 
		 * 
		 * 
		 * driver.findElementByXPath("//android.widget.TextView[@text='Date Widgets']").
		 * click();
		 */

		WebElement expandList = driver.findElementByXPath("//android.widget.TextView[@text='Preference']");
