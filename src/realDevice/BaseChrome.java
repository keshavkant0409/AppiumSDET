...
public class BaseChrome {
	...
	public static AndroidDriver<AndroidElement> setDesiredCapabilities(String device) throws MalformedURLException {
		...
		cap.setCapability("chromedriverExecutable", "C:\\Users\\KeshavKant\\Desktop\\Selenium\\Eclipse2019\\Appium\\Dependency\\chromedriver.exe");

		// cap.setCapability(MobileCapabilityType.APP, fs.getAbsolutePath());

		AndroidDriver<AndroidElement> driver = new AndroidDriver<>(new URL("http://127.0.1:4723/wd/hub"), cap);

		// AppiumDriver<MobileElement> driver=new AppiumDriver<MobileElement>(new
		// URL("http://127.0.1:4723/wd/hub"),cap);
